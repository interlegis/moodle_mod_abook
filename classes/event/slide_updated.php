...
/**
 * The mod_abook slide updated event.
 *
 * @package    mod_abook
...
/**
 * The mod_abook slide updated event class.
 *
 * @package    mod_abook
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class slide_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the slide with id '$this->objectid' for the abook with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'abook', 'update slide', 'view.php?id=' . $this->contextinstanceid . '&slideid=' .
    ...
    public static function get_name() {
        return get_string('eventslideupdated', 'mod_abook');
    }
